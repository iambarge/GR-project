...
The dataset, complete of the raw Motion Capture data, can also be retrived in a more _python-oriented_ format (`.pickle`) in the [GitLab page](https://gitlab.dei.unipd.it/dl_dei/gesture_recognition) of the Department of Information Engineering of the University of Padova.
